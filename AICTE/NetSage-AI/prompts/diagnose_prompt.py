...
# New nested schema for detailed step-by-step fixes
...
class DiagnosticResult(BaseModel):
    ...
    chat_reply: str = Field(...,
                            description="If is_network_issue is False, put your conversational response here. MUST use rich Markdown (bullet points, line breaks, `code blocks`).")
...
- If the user says hello, makes a joke, or asks a general technical question (like explaining a command), set 'is_network_issue' to False.
- For 'chat_reply', you MUST use clean, high-quality Markdown. Break down concepts using bullet points, use **bold text** for emphasis, and strictly format any CLI syntax inside `code blocks`. Never output a dense wall of text.
